module TestElcTranslator (testElcTranslator) where
...
runElcTranslatorTest :: Fl.Prog -> Elc.Exp -> IO ()
runElcTranslatorTest = runTest "ElcTranslator" translateElc

testElcTranslator :: IO ()
testElcTranslator = do
    putStrLn "TODO"
    -- runFlParserTest
    --     "\
    --     \ a = a           \n\
